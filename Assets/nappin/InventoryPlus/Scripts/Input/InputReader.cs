...
namespace InventoryPlus
{
    ...
    public class InputReader : MonoBehaviour
    {
        ...
        [Space(15)]
        [Header("References")]
        public AdvancedWalkerController playerController;
        ...
        private void ToggleInventory()
        {
            ...
            // Example of an InputManager entry: (Input.GetButtonDown("ToggleInventory"))
            if (Input.GetKeyDown(KeyCode.I))
            {
                inventoryOn = !inventoryOn;

                ShowCursor(inventoryOn);
                playerController.enabled = !inventoryOn;
        ...
        private void InventoryActions()
        {
            ...
            // Example of an InputManager entry: (Input.GetButtonDown("UseItem"))
            ...
            // Example of an InputManager entry: (Input.GetButtonDown("DropItem"))
            ...
            // Example of an InputManager entry: (Input.GetButtonDown("SortInventory"))
            ...
            // Example of an InputManager entry: (Input.GetButtonDown("ClearSwap"))
            ...
            // Example of an InputManager entry: (Input.GetButtonDown("CloseInventory"))
